<?php
 ...
 include('../conexion/conn.php');
  ...
  $result = mysqli_query($conn, "SELECT No_Contrato, Trabajos, latitud, longitud, siglas, estatus FROM base WHERE Area='Federales'");
  ...
  while ($row = mysqli_fetch_array($result)) {
     ...
     echo "<td scope='col'>" . $row['estatus'] . "</td>";
      ...
      echo "<td scope='col'><button class='btn btn-danger btn-xs' id='detReporte' onclick='metodo();'>Detalles</button></td>";
      echo "</tr>";
  }
  echo "</tbody></table>";
  echo "</div>";
